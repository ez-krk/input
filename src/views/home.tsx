...
export const HomeView: FC = () => {
  ...
  return (
    <div className="w-screen flex flex-col justify-center items-center">
      <h1 className="leading-relaxed text-5xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-tr from-[#9945FF] to-[#14F195] tracking-widest z-[999]">
